defmodule Crosswake.ProofLane.TemplateContractTest do
  ...
  test "native test templates use deterministic and accessibility-only boundaries" do
    contract = source("priv/templates/crosswake/proof_lane/ios/CrosswakeProofLaneTests/ProofLaneContractTests.swift.eex")
    ui = source("priv/templates/crosswake/proof_lane/ios/CrosswakeProofLaneUITests/ProofLaneUITests.swift.eex")
