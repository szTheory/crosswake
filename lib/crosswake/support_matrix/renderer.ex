defmodule Crosswake.SupportMatrix.Renderer do
  ...
  defp first_adopter_readiness_section do
    [
      ...
      "| physical-iPhone offline study | verification required | A corrected-provenance physical-device record is required before one first adopter offline-study flow can be supported. | This remains limited to one flow on one recorded iOS runtime line when verified. It does not claim Android. It does not claim background replay or sync. It does not claim generic storage or sync. It does not claim multiple offline islands. It does not claim simulator substitution. It does not claim every iPhone. v20 is stopped/partial; it has no shipped support claim. |",
