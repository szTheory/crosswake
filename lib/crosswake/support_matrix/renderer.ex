defmodule Crosswake.SupportMatrix.Renderer do
  ...
  defp first_adopter_readiness_section do
    claims =
      ...
      |> Enum.map(fn claim ->
        "| #{claim_label(claim.activation_state)} | #{claim.statement} | #{claim.boundary} |"
      end)
