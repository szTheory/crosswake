...
`checked-in public-coordinate proof` | published-coordinate mode | `examples/android_shell_host/app/build.gradle`

What this proves: the checked-in Android host resolves `io.github.sztheory:crosswake-shell-core-android` by default.
