defmodule CrosswakeExample.SaaSPortal.StepUpAuditEvent do
  @moduledoc """
  Append-only Sigra step-up lifecycle evidence for the example host.
  """

  use Ecto.Schema
  import Ecto.Changeset

  @event_types ["issue", "challenge", "consume", "cancel", "expire", "revoke", "deny"]
