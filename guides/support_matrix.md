...
| physical-iPhone offline study | device evidence | One checked physical-device artifact covers one first adopter offline-study flow on the recorded iOS 26.6 runtime line. | This device evidence is limited to one flow on one recorded iOS runtime line. It does not claim Android. It does not claim background replay or sync. It does not claim generic storage or sync. It does not claim multiple offline islands. It does not claim simulator substitution. It does not claim every iPhone. v20 is stopped/partial; it has no shipped support claim. |
