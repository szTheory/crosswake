...
| physical-iPhone offline study | verification required | A repaired physical-device admission run is required before one first adopter offline-study flow can be claimed on an iOS runtime line. | This verification-required state is limited to one flow on one recorded iOS runtime line. It does not claim Android. It does not claim background replay or sync. It does not claim generic storage or sync. It does not claim multiple offline islands. It does not claim simulator substitution. It does not claim every iPhone. v20 is stopped/partial; it has no shipped support claim. |
