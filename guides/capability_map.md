...
- **First adopter iOS native navigation shell** — Advisory evidence; Phase 161.1 verifies the bounded contract only: simulator advisory, TODO-002/adopter topology unknown_blocking, and physical-iPhone promotion Phase 162 only.
- **Physical-iPhone offline study and replay evidence** — Future gap; Phase 162 only may promote the first adopter support claim after one physical iPhone proves offline answers, audio, relaunch, replay, account isolation, and remote disablement.
