...
#ifndef CROSSWAKESHELLCORE_SWIFT_H
#define CROSSWAKESHELLCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CrosswakeShellCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18CrosswakeShellCore13BridgeChannel")
@interface BridgeChannel : NSObject <WKScriptMessageHandler>
...
SWIFT_CLASS("_TtC18CrosswakeShellCore23DiagnosticExportManager")
@interface DiagnosticExportManager : NSObject <MXMetricManagerSubscriber>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
