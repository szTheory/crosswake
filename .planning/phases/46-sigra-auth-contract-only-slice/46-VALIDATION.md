...
| 46-02-01 | 02 | 2 | AUTH-02 | T-46-02 | Auth predicates serialize into manifest truth and fail closed when unmet. | integration | `mix test test/crosswake/proof/phase46_sigra_auth_contract_test.exs -x` | Missing W0 | pending |
| 46-03-01 | 03 | 3 | AUTH-02 | T-46-03 | Doctor and support matrix report auth contract truth without claiming Sigra machinery. | integration | `mix test test/crosswake/proof/phase46_sigra_auth_contract_test.exs -x` | Missing W0 | pending |
