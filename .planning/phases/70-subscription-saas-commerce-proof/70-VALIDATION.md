...
| 70-02-01 | 02 | 1 | SAAS-01 | T-70-04 | CI exposes a deterministic merge-blocking Phase 70 proof lane and keeps provider/device checks advisory. | workflow | `mix test test/crosswake/proof/phase70_subscription_saas_commerce_proof_test.exs` | ❌ W0 | ⬜ pending |
| 70-03-01 | 03 | 1 | SAAS-01, SAAS-02 | T-70-05 | Paywall UI renders backend entitlement state honestly and accessibly without adding unscoped subscription-management behavior. | proof | `mix test test/crosswake/proof/phase35_paywall_live_test.exs` | ✅ | ⬜ pending |
