...
- **After every task commit:** Run `mix test test/crosswake/capability_map test/crosswake/guides/evidence_manifest_test.exs -x` once Wave 0 tests exist.
...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 152-W0-01 | TBD | 0 | CAPMAP-01, CAPMAP-02, CAPMAP-03, CAPMAP-04 | T-152-01 | Capability rows cannot overclaim category, package owner, proof posture, or v20 implication. | unit | `mix test test/crosswake/capability_map/capability_map_test.exs -x` | no, Wave 0 | pending |
| 152-W0-02 | TBD | 0 | CAPMAP-04, PROOF-04 | T-152-02 | Rendered guide remains byte-identical to typed capability data. | docs/unit | `mix test test/crosswake/capability_map/renderer_test.exs -x` | no, Wave 0 | pending |
| 152-W0-03 | TBD | 0 | PROOF-03 | T-152-03 | Unsupported native controls, screenshots, offline, and commerce claims cannot render as shipped truth. | docs/unit | `mix test test/crosswake/guides/capability_claims_test.exs -x` | no, Wave 0 | pending |
| 152-W0-04 | TBD | 0 | PROOF-02, PROOF-04 | T-152-04 | Evidence manifest rows distinguish product-surface proof, advisory evidence, demo pressure, future gap, and next-pack candidate posture. | unit | `mix test test/crosswake/guides/evidence_manifest_test.exs -x` | partial, expand in Wave 0 | pending |
