...
- [ ] **Phase 134: Shell Lifecycle + Native UAT Promotion** - Template-version stamping, shell.status, gen.shell --diff, upgrade runbook; Android UAT merge-blocking (code complete + suite green 2026-06-29; verifying — 1 live-PR/CI UAT item pending, deferred to origin-sync boundary)
...
| 134. Shell Lifecycle + Native UAT Promotion | v16.0 | 5/5 | Verifying  | 2026-06-29 |
