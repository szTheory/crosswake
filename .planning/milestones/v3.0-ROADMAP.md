...
- [x] 13-01: Define the normalized commerce vocabulary for paywall entry, purchase intent, restore intent, entitlement snapshot, and reconciliation hooks.
- [x] 13-02: Document backend-truth entitlement flow, reconciliation rules, and explicit non-goals around device-local authority.
- [x] 13-03: Classify core-versus-companion commerce boundaries and identify which storefront-sensitive flows require explicit native screens or guidance.
...
- [x] 14-01: Extend doctor and support-matrix outputs for capability-family, package-boundary, and commerce-seam prerequisites and denials.
- [x] 14-02: Split merge-blocking proof from advisory environment-sensitive proof for future capability and commerce claims.
- [x] 14-03: Publish rebuild guidance, fallback behavior, reviewer/storefront notes, and rough-edge documentation for the new contract surfaces.
