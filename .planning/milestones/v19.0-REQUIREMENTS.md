# Requirements Archive: v19.0 Showcase Apps & Capability Map

**Archived:** 2026-07-12
**Status:** SHIPPED

`.planning/REQUIREMENTS.md` is intentionally removed at milestone close. The next milestone should create a fresh requirements file via `/gsd-new-milestone`.
...
*Archived: 2026-07-12 after v19.0 milestone completion*
