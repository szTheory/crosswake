...
- [x] **Phase 43: Rulestead Hermetic+Advisory Proof And Guide** — hermetic CI lane (no optional dep, asserts fail-closed); advisory lane; `guides/companions.md` rulestead section with docs-contract lock (completed 2026-05-30)
...
| 43. Rulestead Hermetic+Advisory Proof And Guide | v3.5 | 2/2 | Complete    | 2026-05-30 |
