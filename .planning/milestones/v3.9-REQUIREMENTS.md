# Requirements Archive: v3.9 Chimeway Notification Seam
...
- [x] **OPEN-02**: Notification opens for auth-sensitive routes reuse Sigra session authority and step-up semantics before allowing route activation.
...
**Outcome:** All 11 v3.9 requirements validated (TOKN-01/02/03, OPEN-01/02/03, DIAG-01/02, PROOF-01/02) plus REL-01 closeout gate. No requirements adjusted or dropped. APNs/FCM delivery proof remains advisory by design (DLVR-01/02/03 deferred to a future delivery milestone).

---
*Requirements defined: 2026-06-02 from v3.9 research synthesis.*
*Archived: 2026-06-03 — v3.9 shipped with all requirements validated.*
