...
- `examples/phoenix_host/assets/js/app.js` — the EXISTING web↔native bridge (`window.Crosswake.postMessage`, a `transition` nav-intent primitive, `:in_app_navigation` source) — the seam to convert a LiveView navigate into a native push.
