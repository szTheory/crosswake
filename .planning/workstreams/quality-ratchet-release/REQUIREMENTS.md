...
- [x] **SEC-01**: Maintainers can run the root and example-host dependency audits with zero known
  security advisories.

- [x] **SEC-02**: Phoenix, Phoenix LiveView, Plug, and their lockfiles resolve to patched versions
  that remain inside Crosswake's declared public compatibility ranges.

- [x] **SEC-03**: Pull requests receive one stable, actionable dependency-security result that
