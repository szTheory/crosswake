...
| 175-04-03 | 04 | 4 | REL-10 | T-175-20 / T-175-21 | Runbook SHA is a real ancestor, not an assertion | structural (git) | `git merge-base --is-ancestor <sha> HEAD` + `git show --stat` | ❌ W4 creates it | ⬜ pending |
...
| 175-07-02 | 07 | 7 | REL-12 | T-175-36 / T-175-38 / T-175-39 | Published tree equals rehearsed tree | CI run evidence | `gh run view <id> --json conclusion` + `git cat-file -e <merge-sha>` | ❌ W7 creates it | ⬜ pending |
...
| 175-08-02 | 08 | 8 | REL-13 | T-175-41 / T-175-45 / T-175-46 | Per-job conclusions recorded; tag lands on the rehearsed split SHA | CI run + live remote | runbook ancestor check, leg record non-empty, `git ls-remote` reachability | ❌ W8 creates it | ⬜ pending |
