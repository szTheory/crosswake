...
| T-167-17 | Tree identity discards Phase 166 evidence history | Require protected default and every required evidence OID as ancestors of frozen/tested/merged heads. |
| T-167-18 | CI hermeticity is obtained by weakening proof | Require ledger-owned RED/GREEN repairs and an unchanged recurring leaf/failure contract. |
