...
- [x] **PREF-03**: Release integrity has a merge-blocking static test that fails on aggregate gates, stale dependency floors, proof cascades, or missing mirror-token preflight.
...
- [x] **MIRR-03**: Maintainers have an explicit path to verify or backfill the missing iOS `v0.2.0` mirror tag.
