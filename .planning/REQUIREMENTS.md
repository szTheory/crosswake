...
- [x] **THREAD-03**: `crosswake_threadline` publishes to Hex as an independent `release-please` component, gated by `hex.publish --dry-run` + clean-room before publish, after sigra and chimeway are live. (D-7, D-9)
