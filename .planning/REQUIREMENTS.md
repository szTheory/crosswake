...
- [ ] **STEP-01**: A Phoenix host can create server-owned step-up intents for routes that require stronger assurance or fresher authentication, with bounded lifecycle states and manifest-known return targets.
