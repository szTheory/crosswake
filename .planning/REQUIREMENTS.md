...
- [x] **AUTH-01**: A Phoenix team can model an `AuthContext` (actor_id, org_id, mfa_level, auth_age) and a backend-set-only `SessionAuthorityLane`, with device/client auth signals treated as evidence and never as authority.
